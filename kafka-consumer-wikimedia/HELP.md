...
* The original package name 'kafka-consumer-wikimedia.kafka-consumer-wikimedia' is invalid and this project uses 'kafkaconsumerwikimedia.kafkaconsumerwikimedia' instead.
